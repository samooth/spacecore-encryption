...
test('basic', async t => {
  ...
  t.is(block.provider.padding, 8)
  t.ok(block.provider.seekable)
...
test('legacy', async t => {
  ...
  block.encrypt(1, e1, 0)
  block.encrypt(2, e2, 0)

  t.is(e0.byteLength, b0.byteLength + 8)
  t.is(e1.byteLength, b1.byteLength + 8)
  t.is(e2.byteLength, b2.byteLength + 8)

  block.decrypt(0, e0, 0)
  block.decrypt(1, e1, 0)
  block.decrypt(2, e2, 0)
